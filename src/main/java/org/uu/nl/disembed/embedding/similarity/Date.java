...
public abstract class Date implements LiteralSimilarity {
    ...
    private final EmbeddingConfiguration.SimilarityGroup.Time timeDirection;
    private final double alpha;
    private final double offset;
    private final DateTimeFormatter format;

    public Date(String pattern, double alpha, double offset, EmbeddingConfiguration.SimilarityGroup.Time timeEnum) {
        this.alpha = alpha;
        this.offset = offset;
