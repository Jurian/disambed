...
public class NormalizedMyers extends NameSimilarity {

    public NormalizedMyers() {
        super(new Myers());
    }

    static class Myers implements NormalizedStringDistance, NormalizedStringSimilarity {
        /**
